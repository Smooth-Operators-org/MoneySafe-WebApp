            ...
            <div class="container" id="main-container">
                <div class="row">
                    <div class="col s12 24">
                        <h2>Ingresos</h2>
                        <a href="#modal-ingresos" class="btn-floating tooltipped pulse modal-trigger right" data-position="right" data-tooltip="Añadir gasto"><i class="fas fa-plus"></i></a>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col s12 m12 24">
                            ...
                            <tbody>
                                <?php
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $ingreso['fecha_reg']; ?></td>
                                            <td>
                                                <?php
                        ...
                        <div class="collection col s8 m8 l4  blue-grey lighten-1">
                            <p class="collection-item blue-grey lighten-1 white-text"><b>Total: <span class="badge white-text">$<?php echo $total; ?></span></b></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal" id="modal-ingresos">
                    <div class="modal-content">
                        ...
                        <div class="row">
                            ...
                            <div class="row">
                                <div class="input-field col s12">
                                    <input type="text" id="fecha_ing" name="fecha_ing" pattern="[0-9]{4}-[0-9]{2}-[0-9]{2}" class="datepicker container" placeholder="Fecha ingreso">
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="modal-footer">
                                ...
                                <button class="btn green waves-effect waves-light" type="button" id="btn-form">Insertar</button>
                            </div>
                        </div>
                    </div>
